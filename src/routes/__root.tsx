...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "One O Wander · Viajes boutique de lujo" },
      { name: "description", content: "No reservas un viaje. Vives uno. Experiencias de viaje boutique diseñadas para grupos pequeños desde México." },
      { property: "og:title", content: "One O Wander · Viajes boutique de lujo" },
      { property: "og:description", content: "No reservas un viaje. Vives uno. Experiencias de viaje boutique diseñadas para grupos pequeños desde México." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&family=DM+Sans:wght@400;500;700&display=swap",
      },
    ],
  }),
